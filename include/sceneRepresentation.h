...
#include <mrpt/gui.h>
#include <mrpt/utils/CConfigFile.h> // 配置文件
...
//    void initializeScene(Matrix4d x_0, Matrix4d x_0gt);
    ...
    bool updateScene();
    bool updateScene(list<PointFeature *> matched_pt, list<LineFeature *> matched_ls);// 更新场景
    void plotPointsCovariances();
    void plotLinesCovariances();//画出点和线的协方差
